...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{gset} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{getGEO}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{GSE48558\PYZdq{}}\PY{p}{,} \PY{n}{GSEMatrix} \PY{o}{=}\PY{k+kc}{TRUE}\PY{p}{,} \PY{n}{getGPL}\PY{o}{=}\PY{n+nb+bp}{T}\PY{p}{,} \PY{n}{destdir}\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{../Data/\PYZsq{}}\PY{p}{)}
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[scale=0.75]{DR.png}
    \caption{Fig1: Dimensionality Reduction methods}
    \label{fig-1}
\end{figure}\newpage
...
largest variances are the most \textbf{important} and the amount of
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{tsne\PYZus{}results} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{list}\PY{p}{(}\PY{n+nf}{Rtsne}\PY{p}{(}\PY{n+nf}{t}\PY{p}{(}\PY{n}{ex}\PY{p}{)}\PY{p}{,} \PY{n}{perplexity}\PY{o}{=}\PY{l+m}{5}\PY{p}{,} \PY{n}{check\PYZus{}duplicates} \PY{o}{=} \PY{k+kc}{FALSE}\PY{p}{)}\PY{p}{,}
...
\PY{n}{ggarr} \PY{o}{\PYZlt{}\PYZhy{}} \PY{n+nf}{ggarrange}\PY{p}{(}\PY{n}{plotlist} \PY{o}{=} \PY{n}{tsne.plots.list}\PY{p}{,} 
                   ...
                   \PY{n}{labels} \PY{o}{=} \PY{n+nf}{c}\PY{p}{(}\PY{l+m}{5}\PY{p}{,} \PY{l+m}{10}\PY{p}{,} \PY{l+m}{15}\PY{p}{)}\PY{p}{)}
\PY{n+nf}{annotate\PYZus{}figure}\PY{p}{(}\PY{n}{ggarr}\PY{p}{,}
               \PY{n}{bottom} \PY{o}{=} \PY{n+nf}{text\PYZus{}grob}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{tSNE with the perplexity=10 was more successful to separate the data points.\PYZdq{}}\PY{p}{,}
...
\end{tcolorbox}
    ...
    According to the plots, \emph{tSNE} with the \texttt{perplexity=10} was
more successful to separate the data points.
\newpage
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nf}{options}\PY{p}{(}\PY{n}{repr.plot.width}\PY{o}{=}\PY{l+m}{16}\PY{p}{,} \PY{n}{repr.plot.height}\PY{o}{=}\PY{l+m}{10}\PY{p}{)}
\PY{n+nf}{ggarrange}\PY{p}{(}\PY{n}{pca.plot1}\PY{p}{,} \PY{n}{tsne.plots.list}\PY{p}{[[}\PY{l+m}{2}\PY{p}{]]}\PY{p}{,} \PY{n}{mds.plot}\PY{p}{,}
          \PY{n}{ncol} \PY{o}{=} \PY{l+m}{2}\PY{p}{,}
          \PY{n}{nrow} \PY{o}{=} \PY{l+m}{2}\PY{p}{,}
...
\end{tcolorbox}
    ...
    According to plots, we believe that the \texttt{tSNE} was able to
...
or granulocytes have a low correlation with B-cells and T-cells that is
determined by blue color.

According to the heatmap, AML has a high correlation with CD34 and
Monocytes which makes them proper candidates to check whether there are
any significant expression differences between their genes and the AML
ones.
